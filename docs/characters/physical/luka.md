...
import char from '@site/src/data/characters/Luka.json'

# Luka

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Luka.png')} alt="Luka's gacha art" />
...
<Card item={require('../../evidence/characters/physical/luka.md')} />
