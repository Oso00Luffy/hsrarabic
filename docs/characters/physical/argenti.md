...
import char from '@site/src/data/characters/Argenti.json'

# Argenti

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Argenti.png')} alt="Argenti's gacha art" />
...
<Card item={require('../../evidence/characters/physical/argenti.md')} />
