...
import char from '@site/src/data/characters/Sparkle.json'

# Sparkle

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Sparkle.png')} alt="Sparkle's gacha art" />
...
<Card item={require('../../evidence/characters/quantum/sparkle.md')} />
