...
import char from '@site/src/data/characters/Dr._Ratio.json'

# Dr. Ratio

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Dr._Ratio.png')} alt="Dr. Ratio's gacha art" />
...
<Card item={require('../../evidence/characters/imaginary/dr._ratio.md')} />
