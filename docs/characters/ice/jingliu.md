...
import char from '@site/src/data/characters/Jingliu.json'

# Jingliu

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Jingliu.png')} alt="Jingliu's gacha art" />
...
<Card item={require('../../evidence/characters/ice/jingliu.md')} />
