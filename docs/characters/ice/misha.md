...
import char from '@site/src/data/characters/Misha.json'

# Misha

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Misha.png')} alt="Misha's gacha art" />
...
<Card item={require('../../evidence/characters/ice/misha.md')} />
