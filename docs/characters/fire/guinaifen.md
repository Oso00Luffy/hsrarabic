...
import char from '@site/src/data/characters/Guinaifen.json'

# Guinaifen

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Guinaifen.png')} alt="Guinaifen's gacha art" />
...
<Card item={require('../../evidence/characters/fire/guinaifen.md')} />
