...
import char from '@site/src/data/characters/Topaz_&_Numby.json'

# Topaz & Numby

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Topaz_&_Numby.png')} alt="Topaz & Numby's gacha art" />
...
<Card item={require('../../evidence/characters/fire/topaz_&_numby.md')} />
