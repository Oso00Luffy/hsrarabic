...
import char from '@site/src/data/characters/Black_Swan.json'

# Black Swan

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Black_Swan.png')} alt="Black Swan's gacha art" />
...
<Card item={require('../../evidence/characters/wind/black_swan.md')} />
