...
import char from '@site/src/data/characters/Huohuo.json'

# Huohuo

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Huohuo.png')} alt="Huohuo's gacha art" />
...
<Card item={require('../../evidence/characters/wind/huohuo.md')} />
