...
import char from '@site/src/data/characters/Acheron.json'

# Acheron

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Acheron.png')} alt="Acheron's gacha art" />
...
<Card item={require('../../evidence/characters/lightning/acheron.md')} />
