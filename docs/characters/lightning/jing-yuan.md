...
import char from '@site/src/data/characters/Jing_Yuan.json'

# Jing Yuan

import Image from '@theme/IdealImage'

<Image img={require('/img/characters/gacha/Jing_Yuan.png')} alt="Jing Yuan's gacha art" />
...
<Card item={require('../../evidence/characters/lightning/jing-yuan.md')} />
